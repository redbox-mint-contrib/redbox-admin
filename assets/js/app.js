...
.config(['$routeProvider', function($routeProvider) {
  ...
  $routeProvider.when('/workflow-def', {templateUrl: 'partials/workflow-def.html', controller: 'WorkflowTypesCtrl'});
  $routeProvider.when('/workflow-def/:datatype', {templateUrl: 'partials/workflow-def.html', controller: 'WorkflowDefCtrl'});
